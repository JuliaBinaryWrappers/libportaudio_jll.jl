# Autogenerated wrapper script for libportaudio_jll for x86_64-apple-darwin14
...
const libportaudio_splitpath = ["lib", "libportaudio.dylib"]
...
const libportaudio = "@rpath/libportaudio.dylib"


# Relative path to `libpa_shim`
const libpa_shim_splitpath = ["lib", "libpa_shim.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libpa_shim = "@rpath/libpa_shim.dylib"
