...
const libportaudio_splitpath = ["bin", "libportaudio.dll"]
...
const libportaudio = "libportaudio.dll"


# Relative path to `libpa_shim`
const libpa_shim_splitpath = ["bin", "libpa_shim.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libpa_shim = "libpa_shim.dll"
