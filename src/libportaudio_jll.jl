...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libportaudio_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2d7b7beb-0762-5160-978e-1ab83a1e8a31"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libportaudio", artifacts_toml) for e in artifacts["libportaudio"]]
...
if best_platform === nothing
    @debug("Unable to load libportaudio; unsupported platform $(triplet(platform_key_abi()))")
else
